            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(image: NetworkImage(argument.imageUrl.toString()), fit: BoxFit.contain),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(argument.title.toString(), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25, color: Colors.white)),
                    ),
                    Text("£" + argument.price.toString(), style: TextStyle(fontWeight: FontWeight.w500, fontSize: 25, color: Color(0xFF0695b4))),
                  ],
                ),
              ),
              Padding(
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 8, 8, 8),
                child: Text(argument.description.toString(),
                    style: TextStyle(
                      color: Colors.white,
