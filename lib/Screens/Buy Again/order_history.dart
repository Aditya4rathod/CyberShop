  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: isLoading ? orderedProduct[0].data.isEmpty ?
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'No Order Placed till now',style: TextStyle(
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(
                                children: [
                                    ...
                                    children: [
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            TextSpan(text: orderedProduct[0].data[index].quantity.toString(),
                                                style: TextStyle(
                                                    fontSize: 18,
                                                    color: Color(0xFF0695b4),
                                                fontWeight: FontWeight.w900)),
                                  ...
                                  Spacer(),
                                  Text('£ ' + orderedProduct[0].data[index].price.toString(),
                                    style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w900,
                                      color: Colors.white70,
                ...
                // return Card(
                //       child: Container(
                //         child: Image.network(orderedProduct[0].data[index].imageUrl, fit: BoxFit.cover),
                //         : GridTileBar(
                ...
                //           ),
                //           subtitle: Text(
                //             "\£${orderedProduct[0].data[index].price}",
                //             style: TextStyle(
                //               color: Color(0xFF0695b4),
                ...
                //           ),
                //           trailing: Container(
                //             decoration: BoxDecoration(color: Color(0xFF262a34), borderRadius: BorderRadius.circular(10)),
                //             // child: InkWell(
                //             //   onTap: (){
                ...
                //                     //Navigator.pushNamed(context, '/cart');
                //                     // cart.addToCart(orderedProduct[0].data[index].)
                //                   },
                //                   icon: Icon(
                //                     Icons.shopping_cart,
                //                     color: Color(0xFF0695b4),
