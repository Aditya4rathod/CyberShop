   ...
   final cart = Provider.of<CartNotifier>(context);
    return Scaffold(
      ...
      body: Padding(
        ...
        child: isLoading ?  favProduct[0].data.isEmpty ?
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset('assets/images/heart.png', scale: 4.0,),
                SizedBox(height: 20,),
            Text(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              children: [
                                ...
                                IconButton(
                                    onPressed: () {
                                     ...
                                     // favorite.removeFromFavorite(favorite.itemData.removeAt(index));
                                    },
                            ...
                            Row(
                              children: [
                                ...
                                Spacer(),
                                Text('£ ' + favProduct[0].data[index].productDetails.price.toString(),
                                  style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.w900,
                                    color: Colors.white70,
